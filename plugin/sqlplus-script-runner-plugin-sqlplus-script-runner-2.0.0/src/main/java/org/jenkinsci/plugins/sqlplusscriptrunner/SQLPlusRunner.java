...
public class SQLPlusRunner implements Serializable {
    ...
    public void run() throws IOException, InterruptedException {
        ...
        try {
            ...
            listener.getLogger().printf(MSG_ERROR + e);
            throw e;
        } catch (Exception e) {
        ...
        String line;
        BufferedReader bri = new BufferedReader(new InputStreamReader(build.getLogInputStream()));
        ...
        if (exitCode != PROCESS_EXIT_CODE_SUCCESSFUL||sqlplusOutput.toLowerCase().contains("error") ) {
            listener.getLogger().println(LINE);
