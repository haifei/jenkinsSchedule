...
public class ThinBackupMgmtLink extends ManagementLink {
    ...
    public void doSaveSettings(final StaplerRequest res, final StaplerResponse rsp,
                               ...
                               @QueryParameter("backupDir") final boolean backupDir,
                               //2020-05-07 add by wanghf
                               @QueryParameter("backupDirPath") final String backupDirPath,
        ...
        plugin.setBackupDir(backupDir);
        plugin.setBackupDirPath(backupDirPath);
