...
require('jenkins-js-modules').whoami('undefined:config-scrollspy');
...
function nextVisibleSection(section) {
    ...
    return next;
		...
		require('jenkins-js-modules').export(undefined, 'config-scrollspy', {});
    });


},{"./util/page.js":11,"./widgets/config/tabbar.js":16,"jenkins-js-modules":1,"window-handle":5}],7:[function(require,module,exports){
